...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/05/28 16:28:23 by agama             #+#    #+#              #
#    Updated: 2018/06/13 11:50:34 by agama            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c \
     ft_memcmp.c ft_strlen.c ft_strdup.c ft_strcpy.c ft_strcat.c ft_strncat.c \
	 ...
	 ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_strncpy.c ft_lstnew.c \
...
OBJ =  ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o ft_memchr.o \
	  ...
	  ft_putchar_fd.o ft_putstr_fd.o ft_putendl_fd.o ft_putnbr_fd.o ft_strncpy.o \
